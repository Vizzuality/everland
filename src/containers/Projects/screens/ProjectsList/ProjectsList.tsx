...
import { useFetchProjectList } from 'hooks/fetchProjectsList'

export const ProjectsList = () => {
  const { data: projectsList, status } = useFetchProjectList()

  if (status === 'loading') return null // TODO: replace with Loader
